...
vim.opt.cmdheight = 1 -- Will be set to 0 by noice.nvim when it loads
vim.opt.mouse = "" -- Mouse disabled — keyboard-driven workflow
vim.opt.laststatus = 0 -- Will be set to 3 by lualine when it loads
